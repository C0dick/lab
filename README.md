...
### 5. Взаимодействие с неуправляемым кодом
**Цель**: Интеграция с внешними компонентами  
**Задания**:
- Использование COM-объектов (PDF Reader)
- Вызов WinAPI функций (AnimateWindow)
...
**Цель**: Подготовка к распространению  
**Задания**:
